...
const Footer = ({footer}) => {
  return (
    ...
    <div className="Footer">
        ...
        <a href="/#">How To Download Code</a>
        <a href="/#">How To Upload Code</a>
        ...
        <div>
        <p> IMPORTANT LINKS </p>
        <a href="https://www.w3schools.com/" target="blank">Link#1</a>
        <a href="https://www.codingninjas.com/codestudio" target="blank">Link#2</a>
        <a href="https://www.programiz.com/dsa" target="blank">Link#3</a>
        <a href="https://codepen.io/" target="blank">Link#4</a>
    ...
    <div className="FooterBorder">
        <div>
            Copyright &#169; 2022 WebFork. All Rights Reserved
        </div>
    </div>
